...
# ✅ Valid API keys (YOUR ORIGINAL LOGIC)
VALID_API_KEYS = {
    "RIFAT"  # don't change warna api nhi chalega
}

# 🔢 Like limit tracking (YOUR ORIGINAL LOGIC)
daily_limit = 2000
used_count = 0
...
# 🚀 PERFORMANCE FIX 1/2: Accepts the pre-created session (no longer creates a new one)
...
# 🚀 PERFORMANCE FIX 2/2: Creates the session once for 200 concurrent requests
